...
final class LambdaRequestParser extends AbstractRequestParser
{
    ...
    protected function doParse(Request $request, #[\SensitiveParameter] string $secret): ?RemoteEvent
    {
        ...
        if (!$request->getPayload()->has('file_path')
            || !$request->getPayload()->has('provider_id')
            || !$request->getPayload()->has('status')
          ) {
